                        ...
                        <tr style="border-collapse:collapse">
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                    src="https://nxjbfs.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Cảm ơn bạn {{ $data['email'] }} đã đăng ký
                                                                        tài khoản tại website chúng tôi<br></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        <br></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        Để thực hiện việc kích hoạt, vui lòng nhấn vào
                                                                        liên kết dưới đây</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
...
<![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border"
                                                                        style="border-style:solid;border-color:#ffa73b;background:#ffa73b;border-width:1px;display:inline-block;border-radius:9px;width:auto;mso-hide:all"><a
                                                                            href="{{ $data['link'] }}"
                                                                            class="es-button msohide" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;display:inline-block;background:#FFA73B;border-radius:9px;font-family:'source sans pro', 'helvetica neue', helvetica, arial, sans-serif;font-weight:bold;font-style:normal;line-height:24px;width:auto;text-align:center;padding:15px 25px 15px 25px;mso-padding-alt:0;mso-border-alt:10px solid #FFA73B;mso-hide:all">KÍCH
                                                                            HOẠT TÀI KHOẢN</a></span><!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        vui lòng copy đường liên kết sau và dán vào
                                                                        trình duyệt: {{ $data['link'] }}</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        hệ qua email của chúng tôi ở đây: <span
                                                                            style="color:#FF0000"><em><strong>duchuy@gmail.com</strong></em></span><br><em>Đây
